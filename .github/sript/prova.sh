...
echo "::set-output name=RESPONSE_GET::$(curl -s -o /dev/null -w %{http_code}  https://iap.bmwgroup.net/nexus/repository/IAP_Docker_Snapshot/v2/dsa-iam/jwks-auth-service/manifests/1.4.2-SNAPSHOT.eedfbbe)"
